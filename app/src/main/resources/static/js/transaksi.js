    ...
    async function muatRiwayatTabel() {
      ...
      try {
        ...
        if (isPemasukan) {
          ...
          const targetTabungan =
            parseInt(
              localStorage.getItem(`${userPrefix}_target_tabungan`),
              10,
            ) ||
            parseInt(localStorage.getItem("fb_current_target_tabungan"), 10) ||
            500000;
          ...
          const limitAnggaran =
            parseInt(
              localStorage.getItem(`${userPrefix}_limit_anggaran`),
              10,
            ) ||
            parseInt(localStorage.getItem("fb_current_limit_anggaran"), 10) ||
            1000000;
            ...
            datasets: [
              {
                data: dataArray.length > 0 ? dataArray : [1],
                backgroundColor:
                  warnaArray.length > 0 ? warnaArray : ["#e5e7eb"],
              },
            ],
          },
          options: {
